...
demo = {
  initPickColor() {
    $(".pick-class-label").click(function () {
      var newClass = $(this).attr("new-class");
      var oldClass = $("#display-buttons").attr("data-class");
      var displayDiv = $("#display-buttons");
      if (displayDiv.length) {
        var displayButtons = displayDiv.find(".btn");
        displayButtons.removeClass(oldClass);
        displayButtons.addClass(newClass);
        displayDiv.attr("data-class", newClass);
      }
    });
  },
